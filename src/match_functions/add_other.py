...
def write(chart):
    ...
    othered_image.text((x_values[0]-word.calc_length("mcsrranked.com/discord", other_size), text_y), "mcsrranked.com/discord", font=other_font, fill="yellow")
    othered_image.text((x_values[1], text_y), "Bot created by Nadoms :3", font=other_font, fill="lightblue")
